...
const EditDetails = () => {
    ...
    const handleUpdateBtnClick = async(event) => {
        ...
        const result = await fetch(
                `https://warehouse-management-site.herokuapp.com/update-details/${itemId}`,
                requestOptions
            )
            .then((res) => res.json())
    ...
    return ( <
        ...
        Item Name <
        /label> <
        input className = "text-black rounded-lg mb-5 lg:p-2 p-1"
        type = "text"
        ...
        Description <
        /label> <
        textarea onBlur = { handleDescriptionBlur }
        ...
        <
        input className = "bg-orange-600 w-1/4 mx-auto mt-5 py-1 font font-semibold"
        type = "submit"
        value = "Update" /
        >
        <
