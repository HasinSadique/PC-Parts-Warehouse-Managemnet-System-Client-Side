    ...
    return ( <
        div className = "" > { /* Toast Success */ } {
            response ? .result ? .acknowledged ? ( <
                ...
                hover: text - gray - 900 rounded - lg focus: ring - 2 focus: ring - gray - 300 p - 1.5 hover: bg - gray - 100 inline - flex h - 8 w - 8 dark: text - gray - 500 dark: hover: text - white dark: bg - gray - 800 dark: hover: bg - gray - 700 "
        ...
        bg - slate - 700 lg: rounded - 3 xl lg: my - 10 p - 10 " >
        <
        div className = "flex justify-center" >
        <
        img className = "lg:w-1/3 w-1/2 rounded-2xl lg:my-0 my-10 "
        src = { imageUrl }
        alt = "" /
        >
        <
        ...
        <
        span className = "font-semibold text-base" > Item ID: < /span> { _id } <
        /small> <
        ...
        <
        h1 className = "text-xl lg:mb-0 mb-2" > { stockQuantity } { " " } <
        ...
        br / >
        <
        p className = "text-justify" > { description } < /p> { /* Inventory Item manage buttons */ } <
        div className = "flex justify-around mt-10 py-5" >
        <
        a href = { `/edit-details/${itemId}` }
        ...
        /a> <
        /div> <
        a onClick = { handleDeliveredClick }
